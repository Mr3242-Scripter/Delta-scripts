...
local window = wind:CreateWindow({
    ...
    Author = "Follow me on TikTok Mr_3242",
    Folder = "QuantumXMvsdScript",
...
Welcome:Paragraph({
    Title = "Welcome to QuantumX Scripts",
    Desc =
    "We hope you find this script useful, thank you for using this script!",
    ...
    Buttons = {
    {
        ...
        Callback = function()
            setclipboard("https://discord.gg/eZn9Yt6ECK")
            wind:Notify({
    ...
    },
    {
        ...
        Title = "Twitch",
        Callback = function()
            setclipboard("https://www.twitch.tv/QuantumX_42")
            wind:Notify({
                Title = "Twitch Copied!",
                Content = "Twitch link copied to clipboard.",
                Duration = 3,
                Icon = "rbxassetid://139687752061139",
            })
        end,
...
local function FeatureActivated(boolean)
    if boolean then
        wind:Notify({
            ...
            Content =
            "Enjoying QuantumX Scripts? Join our discord server located in the Welcome tab for even better stuff!",
            Duration = 3,
            Icon = "rbxassetid://139687752061139",
        })
    else
